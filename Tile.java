...
public class Tile extends StackPane {
    ...
    public void open(){
        ...
        if (hasMine) {
            Alert alert = new Alert(Alert.AlertType.NONE, "You lost. Good game!", ButtonType.OK);
            alert.showAndWait();
        ...
        if (Minesweeper.tilesOpened == Minesweeper.verticalTiles * Minesweeper.horizontalTiles - Minesweeper.minesNeeded - 1) {
            Alert alert = new Alert(Alert.AlertType.NONE, "You won. Well played!", ButtonType.OK);
            alert.showAndWait();
            if (alert.getResult() == ButtonType.OK) {
                System.exit(0);
                return;
